...
export type ConversionWhereInput = {
  ...
  key?: Prisma.StringFilter<"Conversion"> | string
  co2_value?: Prisma.IntFilter<"Conversion"> | number
  cost_value?: Prisma.IntFilter<"Conversion"> | number
}

export type ConversionOrderByWithRelationInput = {
  key?: Prisma.SortOrder
  co2_value?: Prisma.SortOrder
  cost_value?: Prisma.SortOrder
}
...
export type ConversionScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"Conversion"> | string
  co2_value?: Prisma.IntWithAggregatesFilter<"Conversion"> | number
  cost_value?: Prisma.IntWithAggregatesFilter<"Conversion"> | number
}
...
export type ConversionUpdateInput = {
  ...
  co2_value?: Prisma.IntFieldUpdateOperationsInput | number
  cost_value?: Prisma.IntFieldUpdateOperationsInput | number
}
...
export type ConversionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "co2_value" | "cost_value", ExtArgs["result"]["conversion"]>
...
export interface ConversionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const conversionWithKeyOnly = await prisma.conversion.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Conversions and only return the `key`
   * const conversionWithKeyOnly = await prisma.conversion.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Conversions and only return the `key`
   * const conversionWithKeyOnly = await prisma.conversion.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ConversionFieldRefs {
  readonly key: Prisma.FieldRef<"Conversion", 'String'>
  readonly co2_value: Prisma.FieldRef<"Conversion", 'Int'>
  readonly cost_value: Prisma.FieldRef<"Conversion", 'Int'>
}
